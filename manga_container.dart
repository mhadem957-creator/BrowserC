...
/// Reusable container with thick black borders and hard offset shadows
/// (Neubrutalism / manga ink style).
  ...
  Widget build(BuildContext context) {
    ...
    final container = Container(
      ...
      decoration: BoxDecoration(
        color: color ?? MangaTheme.paper,
        border: Border.all(color: MangaTheme.ink, width: bw),
        boxShadow: [
          BoxShadow(
...
class MangaChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MangaContainer(
      ...
      color: selected ? MangaTheme.crimson : MangaTheme.paper,
      borderWidth: 2.5,
        ...
        children: [
          if (icon != null) ...[
            Icon(
              icon,
              size: 16,
              color: selected ? MangaTheme.paper : MangaTheme.ink,
            ),
